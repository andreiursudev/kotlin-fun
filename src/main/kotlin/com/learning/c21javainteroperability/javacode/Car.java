...
//        }).start();
    ...
    //@NotNull - compiler will generate code so null check is done and throws IllegalArgument exception if argument is null
    //@Nullable - is fine to be null, no exception is thrown
